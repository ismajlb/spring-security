...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
    <a class="navbar-brand" href="http://localhost:8080/conference/">Get Started</a>
</nav>
...
<div class="container">
	...
	<%-- modelAttribute eshte ACCOUNT thats going to tie to an account object  --%>
    <form:form modelAttribute="account" method="post">
        <form:errors path="*" cssClass="errorblock" element="div" />
        <div><label>  <label for="exampleInputEmail1">Username</label>: <input type="text" name="username"/> </label></div>
